 ...
 * 
 * when: 
 * - a super class (interface, abstract class, normal class) and multiple sub classes 
 * base on the input, then return one of its sub-class
 * - need a new instance of a custom builder instead of the global one
 * - need to explicitly define types of objects, that factory can build
 * - need to separated builder and creator interface
 */

public class FactoryExample {
	public static void main(String[] args) {
		
		//Based on the input parameter, different sub classes is Created and Return
